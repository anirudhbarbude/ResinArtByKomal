...
export const products: Product[] = [
  ...
  {
    id: "28",
    name: "Elegant Diya Thali",
    description: "An elegant Diya Thali with intricate resin work.",
    image: getImage("diya-thali-2"),
    category: "Home Decor",
  },
  {
    id: "29",
    name: "Custom Art Work",
    description: "A piece of custom resin artwork.",
    image: getImage("custom-art-work-1"),
    category: "Art work",
  },
  {
    id: "30",
    name: "Diwali Resin Art",
    description: "Special resin art for Diwali.",
    image: getImage("diwali-resin-art-1"),
    category: "Art work",
  },
  {
    id: "31",
    name: "Custom Art Plates",
    description: "Custom decorative plates with resin art.",
    image: getImage("custom-art-plates-1"),
    category: "Home Decor",
  },
  {
    id: "32",
    name: "Resin Make Plates",
    description: "Customizable resin plates for makeup or trinkets.",
    image: getImage("resin-make-plates-1"),
    category: "Home Decor",
  },
  {
    id: "33",
    name: "Floral Art Work",
    description: "A piece of artwork featuring preserved flowers in resin.",
    image: getImage("floral-art-work-1"),
    category: "Art work",
  },
  {
    id: "34",
    name: "Handmade Resin Coaster",
